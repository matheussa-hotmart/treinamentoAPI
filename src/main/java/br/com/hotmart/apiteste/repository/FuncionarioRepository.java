...
public interface FuncionarioRepository extends JpaRepository<Funcionario, Long> {
    ...
    @Query("SELECT new br.com.hotmart.apiteste.model.Funcionario(f.id,f.salario,f.nome,f.cpf,f.dataNascimneto,f.sexo, f.endereco,f.supervisor_id) FROM Funcionario f JOIN FuncionarioProjeto fp ON f.id = fp.funcionario.id JOIN Projeto p ON fp.projeto.id = p.id JOIN Departamento d ON p.departamento.id = d.id WHERE d.nome= :nome ")
